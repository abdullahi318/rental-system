    ...
    <body class="antialiased">
        ...
        <form method="post" action="{{ route('students.store') }}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" value="{{ old('fname') }}" id="fname" name="fname" aria-describedby="fnameHelp">
                @error('fname')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="regNumber" name="regNumber" aria-describedby="regNumberHelp">
                @error('regNumber')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="faculty_id" aria-label="Default select example">
                    ...
                    @foreach($faculties as $fact)
                        <option value="{{ $fact->id }}">{{ $fact->facultyName}}</option>
                    @endforeach
                </select>
                @error('faculty_id')
                    <div class="alert alert-danger">{{ $message }}</div>
